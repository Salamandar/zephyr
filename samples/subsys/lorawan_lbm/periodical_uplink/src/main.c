...
static uint8_t rx_payload_size; /* Size of the payload in the rx_payload buffer */
...
int main(void)
{
	...
	lora_basics_modem_start_work_thread(&modem_event_callback);
	...
	LOG_INF("Periodical uplink (%d sec) example is starting", PERIODICAL_UPLINK_DELAY_S);
